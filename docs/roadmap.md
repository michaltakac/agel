...
| A larger cell table for more programs at once | open | twenty-four cells overflowed the kernel's stack at boot; the workspace is copied on the stack in several frames |
...
| Kernel image headroom | open | 3267 bytes of 260096 after the programs' sources moved to the data region; a size-optimised build outlines routines the ring-3 domains cannot execute |
