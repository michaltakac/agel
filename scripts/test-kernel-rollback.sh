...
dd if=/dev/zero of="$test_image" bs=512 seek=1024 count=66 conv=notrunc 2>/dev/null
dd if=/dev/zero of="$test_image" bs=512 seek=69760 count=4224 conv=notrunc 2>/dev/null
