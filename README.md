...
**Current release: v0.2.74.** It runs DOOM, and Agel plays it with the loop an Agel program in the OS: see [`docs/doom.md`](docs/doom.md). What is done, partial and open is in
