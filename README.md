...
**Current release: v0.2.75.** It runs DOOM, Agel plays it with the loop an Agel program in the OS, and the program keeps its own log there: see [`docs/doom.md`](docs/doom.md). What is done, partial and open is in
